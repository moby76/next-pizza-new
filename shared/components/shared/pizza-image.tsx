//Компонент отображающий изображение товара
        ...
        <div className={cn('flex items-center justify-center flex-1 relative w-full', className)}>
            <img
                ...
                className={cn('relative left-2 top-2 transition-all z-10 duration-300', {
                    'w-[300px] h-[300px]': size === 20,//в зависимости от заданного размера продукта отображаются соответствующие стили изображения
                    'w-[400px] h-[400px]': size === 30,
                    'w-[500px] h-[500px]': size === 40,
                })}
            />

{/* Два блока отображающие круг соответствующие размерам продукта (30 и 40) */}
